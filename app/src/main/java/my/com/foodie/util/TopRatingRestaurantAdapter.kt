...
class TopRatingRestaurantAdapter (
    val fn: (ViewHolder, Restaurant) -> Unit = { _, _ ->}
) : ListAdapter<Restaurant, TopRatingRestaurantAdapter.ViewHolder>(DiffCallback) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.label.text     = "Rating:"
        holder.field.text     = restaurantItem.avgRating.toString() + " ⭐"
