...
class MostViewRestaurantAdapter (
    val fn: (ViewHolder, Restaurant) -> Unit = { _, _ ->}
) : ListAdapter<Restaurant, MostViewRestaurantAdapter.ViewHolder>(DiffCallback) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.label.text     = "View Count:"
        holder.field.text     = restaurantItem.viewCount.toString() + " views"
